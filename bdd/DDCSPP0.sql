...
--
-- Client :  localhost
-- Généré le :  Ven 25 Novembre 2016 à 17:06
...
--
-- Base de données :  `DDCSPP0`
--
CREATE DATABASE IF NOT EXISTS `DDCSPP0` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `DDCSPP0`;
...
CREATE TABLE `role` (
  ...
  `gestion_block` tinyint(1) DEFAULT NULL,
  `gestion_user` tinyint(1) DEFAULT NULL,
  `gestion_them` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `theme` (`id`, `color`, `image`, `opacity`, `bg_repeat`, `bg_parallax`) VALUES
(1, 'red', 'bg.png', 1, 0, 0);
